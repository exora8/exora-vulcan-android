...
scheduler.py -> untuk membuat device AIbox meng upload device.json yang berisi info tentang suhu dan level baterai langsung ke repo github dan bisa di fetch secara live dari html yg udh di hosting di playcode.io

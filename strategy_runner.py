...
def display_welcome_message():
    ...
    print_colored("      Strategic AI Analyst (Ultimate Edition)     ", Fore.CYAN, Style.BRIGHT)
    print_colored("==================================================", Fore.CYAN, Style.BRIGHT)
    print_colored("AI melacak Drawdown, memprediksi durasi, dan belajar dari semua data.", Fore.YELLOW)
...
# DIPINDAHKAN KE ATAS: Fungsi ini didefinisikan sebelum digunakan oleh LocalAI
...
class LocalAI:
    ...
    def check_for_repeated_mistake(self, current_analysis, trade_type, instrument_id):
        ...
        for bad_trade in undesirable_trades: # Tidak ada lagi batasan [-3:]
